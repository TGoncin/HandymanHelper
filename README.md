...
<table align="center">
    <tr>
      <th><h3><strong>Group Members</strong></h3></th>
      <th>Tom Goncin</th>
      <th>Bright Ugbur</th>
    ...
    <tr>
      <th><h3><strong>Student ID</strong></h3></th>
      <th>2004 12666</th>
      <th>2004 61156</th>
      <th>2004 98297</th>
      <th>2004 94054</th>
...
<br> </b>
  ...
  <h2 align="center">Project Abstract</h2>
<br> 
...
<ul style="margin-left: 40px;">
  ...
  <li><strong>Allow contractors to post for free</strong>
      <ul style="margin-left: 40px;">
        Many listings cancel or ban your advertising to force a payment plan for their own advertising with sub-optimal results</li></ul>
            <span style="font-size: 1em;">&nbsp;</span>

  <li><strong>Two-way, verified rating system</strong>
      <ul style="margin-left: 40px;">
        Upon an agreement, both parties agree through the application on a deal being struck, this preventative measure allows both parties to rate one anothers experience through the interaction, upload a photo/video and rate the outcome. Not only is does this reflect the quality of professionalism from both individuals, it enacts a preventative measure to ensure ratings, whether positive or negative are verified from codied deals that were stuck, reducing the ability for bots and fringe groups to target individuals.</li></ul>
            <span style="font-size: 1em;">&nbsp;</span>
    
  <li><strong>Ensure fairness and transparency</strong>
      <ul style="margin-left: 40px;">
        Montractors often face high advertising costs, while clients struggle to compare service quality and pricing with other possibilities other than the major providers</li></ul>
            <span style="font-size: 1em;">&nbsp;</span>
    
  <li><strong>Bidding Option</strong>
      <ul style="margin-left: 40px;">
        Most contracts on the larger scale, such as government contracts offer a bidding option to find the best price for the work they want done; why shouldn’t this be the case for smaller ones as well?</ul></li>
</ul>
<br> 

Handyman Helper creates an environment built on credibility, accountability, and simplicity. By integrating verified profiles, documented credentials, and a transparent bidding system, the platform provides a fair marketplace for skilled workers to find consistent clients—and for clients to confidently choose who enters their homes.<br> 
<br> 
This project directly meets market demand for trustworthy, efficient, and affordable home service solutions while contributing to local economic growth.
<br>
<br> 
